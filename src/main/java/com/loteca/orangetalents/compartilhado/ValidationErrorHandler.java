...
public class ValidationErrorHandler {
    ...
    public ValidationErrorsOutputDto handleValidationError(ConstraintViolationException exception){

        List<ObjectError> globalErrors =  List.of();
        List<FieldError> fieldErrors = List.of(new FieldError("objectName", "email", exception.getMessage()));

        return buildValidationErrors(globalErrors, fieldErrors);
    }

    @ExceptionHandler(MissingServletRequestParameterException.class)
    public ValidationErrorsOutputDto handleValidationError(MissingServletRequestParameterException exception){
        List<ObjectError> globalErrors =  List.of();
        List<FieldError> fieldErrors = List.of(new FieldError("objectName", exception.getParameterName(), exception.getMessage()));
